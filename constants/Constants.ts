export module Constants {
  ...
  export class RoutingConstants extends WebConstants {
    private readonly WEB_API = this.SLASH + this.WEB + this.SLASH + this.API;
    private readonly WEB_API_CONNECTION = this.SLASH + this.CHECK_CONN;
    private readonly WEB_API_REGISTER = this.SLASH + this.REGISTER;
    private readonly WEB_API_LOGIN = this.SLASH + this.LOGIN;
